...
INSERT INTO m_user ( user_id,user_name,password,created_at,updated_at,)
     VALUES ( "k.saito10114@gmail.com","Kosei","SaitoKosei",,NOW(),NOW()),
            ( "yuutakaizyuu2@gmail.com","Yuta","NishizawaYuta",,NOW(),NOW()),
            ( "inoueritsu131@gmail.com","Ritsu","InoueRitsu",,NOW(),NOW()
);
